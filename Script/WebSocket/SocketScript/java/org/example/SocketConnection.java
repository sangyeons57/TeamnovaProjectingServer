...
public class SocketConnection {
    ...
    public Map<String, SocketChannel> userIdMap;
    public Map<String, List<SocketChannel>> channelMap;
    ...
    public boolean setUserId(String userId, SocketChannel channel){
    ...
    public boolean setChannelId(String channelId, SocketChannel channel){
        if(channelId == null || channel == null) {
            return false;
        }
        if(channelId.equals(UserData.NOT_SETUP)) {
            return false;
        }
        if(!userMap.containsKey(channel) || userMap.get(channel).userId.equals(UserData.NOT_SETUP)) {
            return false;
        }

        //이전 체널의 체널 아이디로 체널 접근해서 제거
        String beforeChannelId = userMap.get(channel).channelId;
        if (!beforeChannelId.equals(UserData.NOT_SETUP)) {
    ...
    public static boolean trySendMessage(String userId, String message){
