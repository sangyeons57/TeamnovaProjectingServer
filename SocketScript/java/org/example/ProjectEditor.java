...
public class ProjectEditor {
    ...
    public static ProjectEditor GenerateNewProject(String projectName, String imageName){
        return new ProjectEditor(projectName, imageName);
    }
    ...
    private ProjectEditor(String projectName, String imageName){
        this();
        this.projectId = MysqlManager.Instance().createProject(projectName, imageName, isOpen);
