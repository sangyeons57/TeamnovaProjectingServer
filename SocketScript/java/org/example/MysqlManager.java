...
public class MysqlManager {
    ...
    public int createProject(String projectName, String profileImage, boolean isOpen){
        String query1 = "INSERT INTO project (name, profile_image, is_open) VALUES (?, ?, ?)";
        ...
        try {
            ...
            try (PreparedStatement statement1 = connection.prepareStatement(query1, PreparedStatement.RETURN_GENERATED_KEYS);
                ...
                statement1.setString(2, profileImage);
    ...
    public int getOtherDMChannelId(int channelId, int userId){
    ...
    public Map<String, Object> getProjectData(int projectId){
         String query = "SELECT id, name, profile_image, is_open, status FROM project WHERE id = ?";
        try (PreparedStatement statement = connection.prepareStatement(query)){
            statement.setInt(1, projectId);
            try ( ResultSet resultSet = statement.executeQuery(); ){
                if(resultSet.next()){
