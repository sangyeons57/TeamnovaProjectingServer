...
public class SocketEventListener {
    ...
    public void Register(){
        ...
        addEvent(eType.GET_FILE_PATH, new GetFilePath());
        ...
        addEvent(eType.GET_FILE, new GetFile());
        ...
        addEvent(eType.SEND_MESSAGE_SPECIFIC_PERSON, new SendMessageSpecificPerson());
        addEvent(eType.SET_USER, new SetUser());
        addEvent(eType.SET_PROFILE_IMAGE, new SetProfileImage());
        addEvent(eType.SET_PROJECT_PROFILE_IMAGE, new SetProjectProfileImage());
